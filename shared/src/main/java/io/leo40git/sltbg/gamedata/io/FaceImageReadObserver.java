...
public interface FaceImageReadObserver {
    default void preReadFacePaletteImages(@NotNull NamedFacePalette palette) {}
    ...
    default void postReadFacePaletteImages(@NotNull NamedFacePalette palette, @Nullable FacePaletteIOException exc) {}
}
